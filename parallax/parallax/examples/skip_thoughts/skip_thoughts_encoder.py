...
Original source : https://github.com/tensorflow/models/tree/master/skip_thoughts
...
class SkipThoughtsEncoder(object):
    ...
    """
        self._sentence_detector = nltk.data.load(
    ...
    def _create_restore_fn(self, checkpoint_path, saver):
        ...
        Args:
          checkpoint_path: Checkpoint file or a directory containing
            a checkpoint file.
        ...
        Raises:
          ValueError: If checkpoint_path does not refer to a checkpoint file or
            a directory containing a checkpoint file.
        """
    ...
    def build_graph_from_proto(self, graph_def_file, saver_def_file,
                               checkpoint_path):
        """Builds the inference graph from serialized GraphDef and SaverDef
        protos.
    ...
    def _preprocess(self, data, use_eos):
        ...
        Returns:
          embeddings: A list of word embedding sequences corresponding to the
            input strings.
        """
        preprocessed_data = []
        for item in data:
            ...
            preprocessed_data.append(
                [self._word_to_embedding(w) for w in tokenized])
    ...
    def encode(self,
        ...
        Returns:
          thought_vectors: A list of numpy arrays corresponding to the
            skip-thought encodings of sentences in 'data'.
        """
